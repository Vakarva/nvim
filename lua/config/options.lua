-- Display Settings
vim.opt.colorcolumn = '100'     -- Visual guide at 100 characters (modern default)
...
-- Modern JavaScript/TypeScript: Allow longer lines for complex expressions
vim.api.nvim_create_autocmd("FileType", {
    pattern = {"javascript", "javascriptreact", "typescript", "typescriptreact"},
    callback = function()
        vim.opt_local.colorcolumn = "120"
    end,
    desc = "Extended line length for modern JS/TS development"
})
